resource "circonus_graph" "serf-coordinate-adjustment" {
  ...
  stream {
    ...
    stream_name = "${circonus_metric.serf-coordinate-adjustment.name}"
...
resource "circonus_graph" "serf-events" {
  ...
  stream {
    check = "${circonus_check.consul.check_by_collector[var.collector_id]}"
    stream_name = "${circonus_metric.serf-events.name}"
  ...
  stream {
    check = "${circonus_check.consul.check_by_collector[var.collector_id]}"
    stream_name = "${circonus_metric.serf-events-consul-new-leader.name}"
  ...
  stream {
    check = "${circonus_check.consul.check_by_collector[var.collector_id]}"
    stream_name = "${circonus_metric.serf-member-failed.name}"
  ...
  stream {
    check = "${circonus_check.consul.check_by_collector[var.collector_id]}"
    stream_name = "${circonus_metric.serf-member-flap.name}"
  ...
  stream {
    check = "${circonus_check.consul.check_by_collector[var.collector_id]}"
    stream_name = "${circonus_metric.serf-member-join.name}"
  ...
  stream {
    check = "${circonus_check.consul.check_by_collector[var.collector_id]}"
    stream_name = "${circonus_metric.serf-member-left.name}"
...
resource "circonus_graph" "serf-msgs" {
  ...
  stream {
    check = "${circonus_check.consul.check_by_collector[var.collector_id]}"
    stream_name = "${circonus_metric.serf-msgs-sent.name}"
  ...
  stream {
    check = "${circonus_check.consul.check_by_collector[var.collector_id]}"
    stream_name = "${circonus_metric.serf-msgs-received.name}"
...
resource "circonus_graph" "serf-snapshots" {
  ...
  stream {
    check = "${circonus_check.consul.check_by_collector[var.collector_id]}"
    stream_name = "${circonus_metric.serf-snapshot-append-line.name}"
  ...
  stream {
    check = "${circonus_check.consul.check_by_collector[var.collector_id]}"
    stream_name = "${circonus_metric.serf-snapshot-compact.name}"
